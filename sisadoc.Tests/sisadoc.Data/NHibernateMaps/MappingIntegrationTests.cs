namespace sisadoc.Tests.sisadoc.Data.NHibernateMaps
{
    using System.IO;
    ...
    using global::sisadoc.Infrastructure.NHibernateMaps;
    ...
    public class MappingIntegrationTests
    {
        ...
        public virtual void SetUp()
        {
            ...
            this.configuration = NHibernateSession.Init(
                ...
                "../../../../Solutions/sisadoc.Web.Mvc/NHibernate.config");
        }
        ...
        public void CanConfirmDatabaseMatchesMappings()
        {
            ...
            foreach (var entry in allClassMetadata)
            {
                ...
                if (entry.Value.EntityName.ToString() != "sisadoc.Domain.Entity1")
                {
                   // Assert.AreEqual(1, entry.Value.EntityName.ToString());
                    NHibernateSession.Current.CreateCriteria(entry.Value.GetMappedClass(EntityMode.Map))
                         .SetMaxResults(0).List();

                }
                else {
                    // siempre
                   // Assert.AreEqual("sisadoc.Domain.Entity1", entry.Value.EntityName.ToString());
